import 'package:flutter/material.dart';
  ...
  class PlaySheetBottom extends ConsumerWidget {
    ...
    const PlaySheetBottom(
        {required this.scrollController, super.key, required this.chapterTitle});
    ...
    Widget build(BuildContext context, WidgetRef ref) {
      ...
      // Lấy giá trị an toàn
      final offset = position.pixels.clamp(0.0, double.infinity);
      final maxScrollExtent = position.maxScrollExtent.clamp(
          0.0, double.infinity);
      ...
      double progress = 0.0;
      if (maxOffset > 0) {
        progress = (offset / maxOffset).clamp(0.0, 1.0);
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            // ===== DÙNG progress ĐÃ CHECK, KHÔNG TÍNH LẠI =====
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(
                  '${(progress * 100).toStringAsFixed(1)} %', // ← Dùng progress
                  style: TextStyle(
                    fontSize: 14,
                  ...
                  child: Padding(
                    ...
                    child: SliderTheme(
                      ...
                      child: Slider(
                        ...
                        value: progress,
                        // ← Dùng progress đã check
                        min: 0,
                        max: 1,
                        onChanged: (value) {
                          if (maxOffset > 0) { // ← Check thêm lần nữa
